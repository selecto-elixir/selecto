defmodule Selecto.TaggingIntegrationTest do
  ...
  describe "Tagging Join Integration" do
    ...
    test "tagging and hierarchical joins can be configured together" do
      ...
      tagging_result =
        Tagging.build_tagging_join_with_aggregation(selecto, :tags, tagging_config, [], [], [])

      hierarchy_result =
        Hierarchy.build_adjacency_list_cte(selecto, :categories, hierarchy_config)
  ...
  describe "Advanced Tagging Scenarios" do
    test "multiple tagging configurations can be handled" do
      ...
      tags_result =
        Tagging.build_tagging_join_with_aggregation(selecto, :tags, tags_config, [], [], [])

      categories_result =
        Tagging.build_tagging_join_with_aggregation(
          selecto,
          :categories,
          categories_config,
          [],
    ...
    test "tagging join handles minimal configuration" do
      ...
      result =
        Tagging.build_tagging_join_with_aggregation(selecto, :labels, minimal_config, [], [], [])
  ...
  describe "Phase 3 Completion Validation" do
    test "all tagging functionality is implemented and working" do
      ...
      integration_result =
        Tagging.build_tagging_join_with_aggregation(selecto, :tags, join_config, [], [], [])
    ...
    test "tagging SQL patterns match implementation plan expectations" do
      ...
      {from_clause, _, _} =
        Selecto.Builder.Sql.Tagging.build_tagging_join_with_aggregation(
          selecto,
          :tags,
          config,
          [],
      ...
      {filter_sql_iodata, _} =
        Selecto.Builder.Sql.Tagging.build_faceted_tag_filter(
          config,
          ["elixir", "phoenix"],
          :any
        )
