defmodule Selecto.Builder.ValuesClauseTest do
  ...
  describe "basic VALUES SQL generation" do
    test "generates SQL for list of lists data" do
      ...
      expected =
        ~s[VALUES ('PG', 'Family Friendly', 1), ('PG-13', 'Teen', 2), ('R', 'Adult', 3) AS rating_lookup ("rating_code", "description", "sort_order")]
    ...
    test "generates SQL for list of maps data" do
      ...
      expected =
        ~s[VALUES (31, 1, 'January'), (28, 2, 'February') AS months ("days", "month", "name")]
    ...
    test "handles NULL values correctly" do
      ...
      expected =
        ~s[VALUES ('A', NULL, 1), (NULL, 'B', 2) AS values_table ("col1", "col2", "col3")]
    ...
    test "handles different data types" do
      ...
      expected =
        ~s[VALUES ('text', 42, 3.14, TRUE, FALSE) AS values_table ("text_col", "int_col", "decimal_col", "bool_true", "bool_false")]
  ...
  describe "data type formatting" do
    test "formats string values with proper escaping" do
      ...
      expected =
        ~s[VALUES ('O''Reilly', 'He said "Hello"'), ('Text with, commas', 'Text with\nnewlines') AS values_table ("col1", "col2")]
    ...
    test "formats date and time values" do
      ...
      expected =
        ~s[VALUES ('2023-01-01', '2023-01-01T12:00:00Z', '2023-01-01T12:00:00') AS values_table ("date_col", "datetime_col", "naive_datetime_col")]
    ...
    test "formats numeric values without quotes" do
      ...
      expected =
        ~s[VALUES (42, 3.14159, -10, 0.0) AS values_table ("int", "float", "negative", "zero")]
  ...
  describe "column identifier quoting" do
    ...
    test "quotes column names with special characters" do
      ...
      expected =
        ~s[VALUES ('value1', 'value2') AS test_table ("column with spaces", "column-with-dashes")]
