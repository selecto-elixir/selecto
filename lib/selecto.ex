defmodule Selecto do
  ...
  """
  def with_cte(selecto, member_id) when is_atom(member_id) or is_binary(member_id),
    do: Selecto.CteQuery.with_cte(selecto, member_id)

  def with_cte(selecto, member_id, opts)
      when (is_atom(member_id) or is_binary(member_id)) and (is_list(opts) or is_map(opts)),
      do: Selecto.CteQuery.with_cte(selecto, member_id, opts)

  def with_cte(selecto, name, query_builder, opts \\ []),
    do: Selecto.CteQuery.with_cte(selecto, name, query_builder, opts)
  ...
  """
  def with_recursive_cte(selecto, arg2, arg3, arg4 \\ nil, arg5 \\ []),
    do: Selecto.CteQuery.with_recursive_cte(selecto, arg2, arg3, arg4, arg5)
