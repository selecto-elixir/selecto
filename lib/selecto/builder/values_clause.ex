defmodule Selecto.Builder.ValuesClause do
  ...
  defp build_parameterized_values_rows([row | rest], :list_of_lists, param_index, parameters) do
    {row_sql, new_param_index, row_parameters} =
      build_parameterized_row_from_list(row, param_index)

    {rest_sql, rest_parameters} =
      build_parameterized_values_rows(
        rest,
        :list_of_lists,
        new_param_index,
  ...
  defp build_parameterized_values_rows([row | rest], :list_of_maps, param_index, parameters) do
    {row_sql, new_param_index, row_parameters} =
      build_parameterized_row_from_map(row, param_index)
