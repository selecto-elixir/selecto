defmodule Selecto.Window do
  ...
  defmodule Spec do
    ...
    """
    defstruct [
      # Unique identifier for the window function
      :id,
      # Window function type (:row_number, :rank, :sum, etc.)
      :function,
      # Arguments to the function (e.g., ["sales_amount"] for SUM)
      :arguments,
      # Fields to partition by
      :partition_by,
      # Fields and directions to order by
      :order_by,
